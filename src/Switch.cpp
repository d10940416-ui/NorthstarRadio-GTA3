...
// ============================================================
static long* const pMouseWheelCurrentZ = (long*)0x6F4EAC;
static long* const pMouseWheelPrevZ    = (long*)0x6F4E78;
...
// ============================================================
#define GTA3_ADDR_ChangeStationJustDown   ((void*)0x57FEE0)
...
// ============================================================
#define GTA3_ADDR_SetRadioInCar         ((void*)0x57F440)
#define GTA3_ADDR_VehicleRadioProcess   ((void*)0x57FB10)
...
//           GTA3_TODO: Verify opcode number in GTA III.
// ============================================================
#define GTA3_ADDR_ProcessOneCommand     ((void*)0x4386C0)
...
public:
    SwitchDetectorPlugin()
    {
        ...
        Events::gameProcessEvent.Add([]()
        {
            ...
            if (pMouseWheelCurrentZ && pMouseWheelPrevZ) {
                long delta = *pMouseWheelCurrentZ - *pMouseWheelPrevZ;

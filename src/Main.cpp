...
public:
    NoRadioPlugin()
    {
        ...
        Events::gameProcessEvent.Add([]()
        {
            ...
            // GTA3_TODO: VC used TheCamera.m_bWideScreenOn; GTA III uses
            // TheCamera.m_bWideScreen (field renamed). If this causes a
            // compile error, change m_bWideScreen to the correct GTA III name.
            bool inCutscene = CCutsceneMgr::ms_running || TheCamera.m_bWideScreen;
        ...
        Events::drawHudEvent.Add([]()
        {
            ...
            CFont::SetJustifyOff();
            // GTA3_TODO: if SetBackgroundOff / SetBackGroundOnlyTextOff do not
            // exist in GTA III's CFont, remove the two lines below.
